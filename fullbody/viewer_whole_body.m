...
%   Full-body viewer for the VHP model of 01/15/2015
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Aorta_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [0.85 0.7 1]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Bicep_left_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [1 0.75 0.65]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Bicep_right_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [0.48 0.06 0.89]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Cerebellum_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [0.5 0.9 0.65]);
count = size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Eye_left_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [0.6 0.2 0]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Eye_right_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'none', 'FaceAlpha', 0.2,'FaceColor', [1 0.75 0.65]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 0.4,'FaceColor', [1 0 0]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_GreyMatter.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 0.5,'FaceColor', [0.7 0.3 0.7]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
load('VHP_Hamstring_left_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Hamstring_right_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Heart_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [0 1 0]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Intestine_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [1 1 0]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Jaw_M.mat');
PP = P';
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Kidney_left_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [1 0.6 0.78]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Kidney_right_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_LatissimusDorsi_left_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 0.4,'FaceColor', [0.5 0.9 0.65]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_LatissimusDorsi_right_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Liver_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [0.7 0.8 0.9]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Lungs_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'none', 'FaceAlpha', 0.5,'FaceColor', [0 1 1]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Quadriceps_left_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Quadriceps_right_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Sinus_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [0.2 0.75 0.65]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Skin.mat');
PP = P';
...
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'none', 'FaceAlpha', 0.0,'FaceColor', [1 0.75 0.65]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Skull.mat');
PP = P';
...
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 0.3,'FaceColor', [1 0.8 0.7]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Stomach_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [1 0 1]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Tongue_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1,'FaceColor', [0 0.5 0]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1.0,'FaceColor', [0.85 0.16 0]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Trapezious_right_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'b', 'FaceAlpha', 1.0,'FaceColor', [1 0.75 0.65]);
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_Trapezious_left_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
...
count = count + size(t,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('VHP_WhiteMatter_M.mat');
PP = P';
tt = t';
Xshape = reshape(PP(1, tt(1:3,:)),[3,size(tt,2)]);
Yshape = reshape(PP(2, tt(1:3,:)),[3,size(tt,2)]);
Zshape = reshape(PP(3, tt(1:3,:)),[3,size(tt,2)]);
patch(Xshape, Yshape, Zshape, [1 0.75 0.65], 'EdgeColor', 'k', 'FaceAlpha', 1.0,'FaceColor', [1 1 0]);
