function fig_hdl = E21
%   SYNTAX
%   E21
%   DESCRIPTION
%   This module accurately computes the capacitance of a parallel-plate
%   capacitor. It also computes charge distributions on capacitor plates,
%   electric field distribution in a plane, and electric field at a point
%   of interest (marked by a cross). Arbitrary (non-equal) plane sizes
%   and/or orientations may be tested
%   
...
strge.Z(2)              = 0.1;         %   center position z, m
...
%%  Functions
   function outputgraphics
    ...
    function cleaning
        %   cleanig figure without re-plotting
    ...
    function simulate(strge, strop, strsc, R, gauss)         
        ...
        Ctheory     = min(strge.L)*min(strge.W)*eps0/temp*1e12;                
        ...
        strout.Ctheory  = Ctheory;                  %    Analytical (C=A*eps0/d) capacitance in pF
...
%% ---------------------------------------------------------------------------
    function build_gui()
        ...
        handles.figure1 = figure( ...
            ...
            'Name', 'E21-Capacitance of a parallel-plate capacitor - MoM/BEM numerical solution', ...
            'MenuBar', 'none', ...
            'NumberTitle', 'off', ...
        ...
        handles.abstract = uicontrol( ...
            ...
            'FontSize', 8, ...
            'FontUnits', 'pixels', ...
            'string','This module accurately computes the capacitance of a parallel-plate capacitor. It also computes charge distributions on capacitor plates, electric field distribution in a plane, and electric field at a point of interest (marked by a cross). Arbitrary (non-equal) plane sizes and/or orientations may be tested');
        ...
        function SimulateCallback(~,~)
            simulate(strge, strop, strsc, R, gauss);
        end
