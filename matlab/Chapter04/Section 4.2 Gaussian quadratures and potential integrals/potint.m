...
%   SYNTAX 
%   [I, IRho] = potint(r1, r2, r3, normal, ObsPoint) 
%   DESCRIPTION 
%   This function returns single potential MoM integrals I = Is(1/r) given
%   by Eq. (4.25) and integrals IRho=Is(vec(r)/r), respectively,  and
