...
%   permeability should be greater than 100.
%   
...
%%  Functions
    function outputgraphics
        ...
        %%  Find the H-field/B-field at observation point(s) (altered)
    ...
    function simulate()        
        ...
        V = sum(normals.*repmat(strei.Hinc, length(t), 1), 2);
    ...
    function build_gui()
        ...
        handles.figure1 = figure( ...
            ...
            'Name', 'E62-Magnetic object in an external magnetic field-MoM/BEM numerical solution (mu_r>100)', ...
            'MenuBar', 'none', ...
            'NumberTitle', 'off', ...
        ...
        handles.abstract = uicontrol( ...
            ...
            'FontSize', 8, ...
            'FontUnits', 'pixels', ...                    
            'String', 'This module computes fields and "bound charges" for a magnetic object in an external magnetic field. The object may be a sphere, brick, cylinder, or an arbitrary external object. The module also computes "bound charge" distributions, magnetic field distribution in a plane, and magnetic field/scalar potential at a point of interest. Object''s relative permeability should be greater than 100.');
