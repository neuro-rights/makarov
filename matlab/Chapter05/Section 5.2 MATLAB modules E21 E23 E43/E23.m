function fig_hdl = E23
%   SYNTAX
%   E23
%   DESCRIPTION
%   This module is an accurate 3D electrostatic MoM solution of a
%   two-conductor problem. The conducting objects may be a plate or a
%   circle, a conducting brick, a sphere, or a cylinder. The conducting
%   objects may have arbitrary orientations versus each other. The module
%   also computes charge distributions on conductors, electric field
...
objecttype{1}           = 'brick';       %   'none' or 'plate', 'sphere', 'brick', or 'cylinder' is allowed
objecttype{2}           = 'cylinder';    %   'none' or 'plate', 'sphere', 'brick', or 'cylinder' is allowed
...
strsphere.Z(1)          = -0.01;       %   center position z, m
...
strsphere.a(2)          = 0.04;         %   sphere radius, m
strsphere.X(2)          = 0;            %   center position x, m
strsphere.Y(2)          = 0;            %   center position y, m
strsphere.Z(2)          = 0.16;         %   center position z, m
...
strbrick.L(1)          = 0.15;          %    brick length, m
strbrick.W(1)          = 0.20;          %    brick width, m
strbrick.H(1)          = 0.01;          %    brick height, m
...
strbrick.L(2)          = 0.15;          %    brick length, m
strbrick.W(2)          = 0.20;          %    brick width, m
strbrick.H(2)          = 0.01;          %    brick height, m
strbrick.X(2)          = 0.1;           %    center position x, m
strbrick.Y(2)          = 0;             %    center position y, m
strbrick.Z(2)          = 0.15;          %    center position z, m
...
strcylinder.H(1)          = 0.15;       %     cylinder height, m
...
strcylinder.R(2)          = 0.01;       %     cylinder radius, m
strcylinder.H(2)          = 0.15;       %     cylinder height, m
strcylinder.X(2)          = 0;          %     center position x, m
strcylinder.Y(2)          = 0;          %     center position y, m
strcylinder.Z(2)          = 0.085;      %     center position z, m
strcylinder.ax(2)         = 0;          %     rotate about the x-axis, deg
strcylinder.ay(2)         = 45;         %     rotate about the y-axis, deg
...
strcircle.R(2)              = 0.1;          %   circle radius, m
strcircle.X(2)              = 0;            %   center position x, m
strcircle.Y(2)              = 0;            %   center position y, m
strcircle.Z(2)              = 0.06;         %   center position z, m
strcircle.ax(2)             = 30;           %   rotate about the x-axis, deg
...
strop.planez = 0.11;         %   plane center: z in m
...
%%  Functions
    ...
    function geometry()        
        ...
        strout.Patches1         = size(tD{1}, 1);           %    Number of triangular patches for the first object
        strout.Patches2         = size(tD{2}, 1);           %    Number of triangular patches for the second object
        c = zeros(size(t, 1));
    ...
    function simulate()        
        ...
        Charge1     = sum(Charge(t(:, 4)==1));      %   total charge of the first conductor, C
        Charge2     = sum(Charge(t(:, 4)==2));      %   total charge of the second conductor, C
        ChargeTotal = Charge1 + Charge2;
        ...
        strout.Charge1          = Charge1;                  %    Total charge of the first object, C
        strout.Charge2          = Charge2;                  %    Total charge of the second object, C
        strout.ChargeTotal      = ChargeTotal;              %    Total charge of the entire structure, C
        strout.E;                                           %    E-field at the observation point (if any)
        strout.Patches1;                                    %    Number of triangular patches for the first object
        strout.Patches2;                                    %    Number of triangular patches for the second object
        strout.PatchesTotal;                                %    Total number of triangular patches in the mesh
        strout.quality  = min(simpqual(P, t));
...
%% ---------------------------------------------------------------------------
    function build_gui()
        ...
        handles.figure1 = figure( ...
            ...
            'Name', 'E23-A capacitor formed by two arbitrary conductors-MoM/BEM numerical solution', ...
            'MenuBar', 'none', ...
            'NumberTitle', 'off', ...
        ...
        function fOutputDataCallback(~, ~)
            ...
            data = {...
                ...
                'Total charge of the first object, C',strout.Charge1;...
                'Total charge of the second object, C',strout.Charge2;...
                ...
                'Total number of triangular patches for the first object',strout.Patches1;...
                'Total number of triangular patches for the second object',strout.Patches2;...
       ...
       % --- View Direction ---
        ...
        handles.abstract = uicontrol( ...
            ...
            'FontSize', 8, ...
            'FontUnits', 'pixels', ...
            'String', 'This module is an accurate 3D electrostatic MoM solution of a two-conductor problem. The conducting objects may be a plate or a circle, a conducting brick, a sphere, or a cylinder. The conducting objects may have arbitrary orientations versus each other. The module also computes charge distributions on conductors, electric field distribution in a plane, and electric field at a point of interest.');
