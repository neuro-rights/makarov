function fig_hdl = E40
%   SYNTAX
%   E40
%   DESCRIPTION
%   This module is an accurate 3D electrostatic MoM solution for a
%   self-capacitance of a conducting human body. 19 body meshes from three
...
objecttype{1}           = 'person1_twisting.mat';  
...
strsc.positive = 0.3;       %   positive charge densities higher than this number times the average
...
strout.quality          = 0;        %    Minimum triangle quality in the mesh;
...
handles.object   = 2;
% Default Body Info.
TEMP = load('person1_twisting.mat','-mat');
P = TEMP.P;
t = TEMP.t;
...
%%  Functions
    function outputgraphics
        ...
        graphics_S40(io, strop, stroc, P, t, c, Area, strsc); 
    end
    ...
    function geometry()        
        ...
        % ADD .BDY
        if ~strcmp(objecttype{1}, 'person1_twisting.mat')
    ...
    function simulate()        
        ...
        strout.quality         = min(simpqual(P, t));       %    Minimum triangle quality in the mesh;
...
%% ---------------------------------------------------------------------------
    function build_gui()
        ...
        handles.figure1 = figure( ...
            ...
            'Name', 'E40-Self-capacitance of a human body-MoM/BEM numerical solution', ...
            'MenuBar', 'none', ...
            'NumberTitle', 'off', ...
...
%                 normals = TEMP.normals;   
        ...
        function fOutputDataCallback(~, ~)
            ...
            data = {...
                ...
                'Minimum quality of triangular patches in the mesh',strout.quality;...
       ...
       % --- View Direction ---
        ...
        handles.abstract = uicontrol( ...
            ...
            'FontSize', 8, ...
            'FontUnits', 'pixels', ...            
            'String', 'This module is an accurate 3D electrostatic MoM solution for a self-capacitance of a conducting human body. 19 body meshes from three real subjects are available. In DC steady state, the internal structure of the body is not significant since the field inside the body is exactly zero. The module also computes electric field distribution in a plane, and electric field at a point of interest.');
        % --- PUSHBUTTONS -------------------------------------
...
function [P, t] = cylinder(R, H, Tr, par);
    ...
    %   cylinder with radius R, height h, and orientation along 
