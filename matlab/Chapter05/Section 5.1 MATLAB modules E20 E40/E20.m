function fig_hdl = E20
%   SYNTAX
%   E20
%   DESCRIPTION
%   This module computes an accurate 3D electrostatic MoM solution for a
%   self-capacitance of basic conducting objects. The conducting objects
%   may be a plate or a circle, a conducting brick, a sphere, or a
%   cylinder. The module also computes charge distributions on conductors,
...
handles.simulate = 0;   %   An indicator that the simulations are complete
handles.object   = 2;
...
%%  Functions
    ...
    function simulate()        
        ...
        Cnum        = 1e12*ChargeTotal/objectpotential{1};
        Cexact      = 1e12*8*eps0*0.1;
...
%% ---------------------------------------------------------------------------
    function build_gui()
        ...
        handles.figure1 = figure( ...
            ...
            'Name', 'E20-Self-capacitance of basic conducting objects - MoM/BEM numerical solution', ...
            'MenuBar', 'none', ...
            'NumberTitle', 'off', ...
        ...
        function fOutputDataCallback(~, ~)
            ...
            columneditable  =  [true];
            data = {...
                'Numerical self-capacitance, pF',strout.Cnum;...
       ...
       % --- View Direction ---
        ...
        handles.abstract = uicontrol( ...
            ...
            'FontSize', 8, ...
            'FontUnits', 'pixels', ...           
            'String', 'This module is an accurate 3D electrostatic MoM solution for a self-capacitance of basic conducting objects. The conducting object may be a plate or a circle, a conducting brick, a sphere, or a cylinder. The module also computes charge distributions on conductors, electric field distribution in a plane, and electric field at a point of interest.');
        % --- PUSHBUTTONS -------------------------------------
...
function [P, t] = cylinder(R, H, Tr, par);
    ...
    %   cylinder with radius R, height h, and orientation about 
...
%     stroc.size = 1;                %   relative marker size versus default size 
    ...
    if io == 0
        ...
        title('Problem geometry: conducting object');
    end
