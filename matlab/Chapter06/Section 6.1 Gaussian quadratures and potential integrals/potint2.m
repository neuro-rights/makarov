...
%   DESCRIPTION 
%   This function returns single potential MoM integrals Int = Is(grad(1/r))
%   given by Eq. (6.14) and follows the method described in Wang Z, Volakis
%   J, Saitou K, Kurabayashi K. Comparison of semi-analytical formulations
%   and Gaussian-quadrature rules for quasi-static double-surface potential
...
%   Outputs:
%   Int - Nx3 array of integrals Int = Is(grad(1/r))
%
%   Test example (comparison with Wang et al, 2003, Table 6.1 of Chapter 6)
%     clear all;
%     format long;
%     r1 = [62.5 25.0 0];
%     r2 = [62.5 25.0 2];
...
%          IntPoint = coeff(1, m)*r1 + coeff(2, m)*r2 + coeff(3, m)*r3;
%          R = IntPoint - ObsPoint;
