...
%   SYNTAX 
%   [coeff, weights, IndexF] = tri(3) -   will output integration points
%   and weights for triangles using barycentric triangle subdivision with 3*3 = 9
%   triangles (their centers are the integration points)
%
%   [coeff, weights, IndexF] = tri(7, 5) - will output integration points
%   and weights for triangles using Gaussian quadrature of fifth (5) order
%   with seven (7) integration points
%
%   DESCRIPTION 
%   This function returns integration points and weights in Eqs. (4.23) and
%   (4.24), respectively, for barycentric triangle subdivision and Gaussian
%   quadratures on triangles, respectively. All Gaussian formulas are
%   adopted (with author's permission) from
%   http://www.cs.kuleuven.ac.be/~nines/research/ecf/ecf.html. 
%   Gaussian formulas of third (4 integration points), fifth (7 integration
%   points), seventh (13 integration points), and tenth (25 integration
%   points) order of accuracy may generated
%   Outputs:
%   coeff - array of coefficients for finding integration points: 
%   InPoint(m, :) = coeff(1, m)*p1 + coeff(2, m)*p2 + coeff(3, m)*p3
%   where p1(1, 3), p2(1, 3), p3(1, 3) are triangle vertices
%   weights - array of weights in Eq. (4.23)
%   IndexF = size(coeff, 2);
%
%   See test1.m, test2.m for examples
%
