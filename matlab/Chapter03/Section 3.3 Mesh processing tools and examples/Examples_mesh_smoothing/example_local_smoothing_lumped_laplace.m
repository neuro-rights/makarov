clear all; close all; 
%   SYNTAX 
%   example_local_smoothing_lumped_laplace
%   DESCRIPTION 
%   This script performs local iterative Laplacian mesh
%   smoothing using the lumped-smoothing algorithm. The smoothing improves
%   triangle quality and increases min edge length but deformes the mesh
%
