...
%   DESCRIPTION 
%   This script demonstrates the use of manual triangle subtraction. A a
%   result, a hole will be formed in the mesh. The script uses MATLAB
%   script select3D.m by Joe Conti to select triangle vertices and add
%   triangles. To add triangles manually, select three vertices and hit
